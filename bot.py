""""
Copyright © TTheHolyOne 2021 - https://github.com/ttheholyone
Version: 1.0
"""
...
async def status_task():
	while True:
		await bot.change_presence(activity=discord.Game("with Mods!"))
		...
		await asyncio.sleep(60)
		await bot.change_presence(activity=discord.Game("999 Forever"))
		await asyncio.sleep(60)
